          ...
          <div className="max-w-4xl mx-auto text-center space-y-8">
            ...
            <div className="w-full max-w-2xl mx-auto px-4 sm:px-0">
              <div className="relative">
                ...
                <Input placeholder="Search any proverb, quote, idiom, simile..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="w-full pl-12 h-14 text-base sm:text-lg backdrop-blur border-2 border-primary-foreground/20 focus:border-wisdom-gold bg-gray-100" />
              </div>
            </div>
          </div>
        </div>

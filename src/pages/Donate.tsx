...
const Donate = () => {
  ...
  const handleTierSelect = (tier: { name: string; amount: string; description: string }) => {
          ...
          <CardContent className="p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                ...
                className="bg-gradient-to-r from-ocean-blue to-ocean-teal hover:from-ocean-teal hover:to-ocean-blue transition-all duration-300"
              >
              ...
              <Button 
                ...
                size="lg"
                onClick={handleDonateClick}
                className="border-ocean-teal text-ocean-teal hover:bg-ocean-teal hover:text-white"
              >
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {donationTiers.map((tier, index) => (
          <Card 
            key={index}
            className={`${tier.gradient} text-white border-0 hover:scale-105 transition-all duration-300 cursor-pointer shadow-card hover:shadow-card-hover`}
  ...
  const renderPaymentSection = () => (
    <div className="space-y-8">
      <div className="text-center">
        ...
        {selectedTier && (
          <div className="inline-block bg-gradient-to-r from-ocean-blue to-ocean-teal text-white px-6 py-3 rounded-lg mb-6">
        ...
        <Card className="border border-ocean-coral/20 hover:border-ocean-coral/40 transition-colors cursor-pointer">
          <CardContent className="p-6 flex items-center justify-between" onClick={handlePaymentComplete}>
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">Cryptocurrency Wallets</h3>
                <p className="text-sm text-muted-foreground">Bitcoin, Ethereum, and more</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="space-y-4">
          ...
          <div>
            <Button 
              variant="ghost" 
              onClick={handleBackToInitial}
              className="text-ocean-blue hover:text-ocean-teal"
            >
